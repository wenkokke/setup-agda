...
export async function pickBuildOptions<
  Options extends Pick<ActionOptions, BuildOptionKey | 'bundle-license-report'>
>(options: Options): Promise<BuildOptions> {
  ...
  return {
    ...
    'license-report': options['bundle-license-report']
  }
}
...
export async function pickBundleOptions<
  Options extends Pick<ActionOptions, BundleOptionKey>
>(options: Options): Promise<BundleOptions> {
  // Validate the Agda version:
  ...
  return {
    ...buildOptions,
    ...pick(options, ['bundle-compress', 'bundle-license-report']),
